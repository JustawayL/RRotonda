...
<html>
	...
	<body  id="body" class="centrado">
		...
		<nav class="navbar navbar-default"><?php include 'plantillas/nav.php' ?></nav>
		<div  class="container">
			<div class="row">
				<section class="jpanel col-md-9">
					<?php
					$pedidos = unserialize($_SESSION["busqueda"]);
					include 'paneles/pedidos.php';
					?>
				</section>
